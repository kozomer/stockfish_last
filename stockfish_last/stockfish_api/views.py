...
class EditProductView(View):
    def post(self, request, *args, **kwargs):
        ...
        product.group = data.get('group')
        product.subgroup = data.get('subgroup')
        product.feature = data.get('feature')
        #product_code_ir için exception
        product.product_code_tr = data.get('product_code_tr')
        product.description_tr = data.get('description_tr')
        product.description_ir = data.get('description_ir')
        product.unit = data.get('unit')
        product.unit_secondary = data.get('unit_secondary')
